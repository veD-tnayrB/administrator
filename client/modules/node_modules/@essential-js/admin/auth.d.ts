...
import * as __beyond_dep_ns_1 from '@essential-js/admin/notifications';
// entities/session.ts
declare namespace ns_0 {
  import ReactiveModel = __beyond_dep_ns_0.ReactiveModel;
  import User = ns_3.User;
  import NotificationsHandler = __beyond_dep_ns_1.NotificationsHandler;
  /**
  ...
  class Session extends ReactiveModel<Session> {
    #private;
    get user(): User;
    get notificationsHandler(): NotificationsHandler;
    /**
