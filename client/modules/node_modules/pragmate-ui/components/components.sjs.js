System.register(["@beyond-js/kernel/bundle", "@beyond-js/kernel/styles", "react", "pragmate-ui/icons", "pragmate-ui/spinner", "pragmate-ui/ripple", "tippy.js", "@beyond-js/kernel/routing"], function (_export, _context2) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5, dependency_6, dependency_7, __Bundle, __pkg, ims, ButtonGroup, Button, Link, Spinner, __beyond_pkg, hmr;
  _export({
    ButtonGroup: void 0,
    Button: void 0,
    Link: void 0,
  ...
  return {
    setters: [function (_beyondJsKernelBundle) {
      ...
      dependency_3 = _pragmateUiIcons;
    }, function (_pragmateUiSpinner) {
      dependency_4 = _pragmateUiSpinner;
    }, function (_pragmateUiRipple) {
      dependency_5 = _pragmateUiRipple;
    }, function (_tippyJs) {
      dependency_6 = _tippyJs;
    }, function (_beyondJsKernelRouting) {
      dependency_7 = _beyondJsKernelRouting;
    }],
    execute: function () {
      ({
        Bundle: __Bundle
