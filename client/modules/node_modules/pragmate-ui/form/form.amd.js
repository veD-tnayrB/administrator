define(["exports", "module", "@beyond-js/kernel/bundle", "react", "pragmate-ui/icons", "@beyond-js/kernel/styles"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.hmr = _exports.__beyond_pkg = _exports.Textarea = _exports.Switch = _exports.Select = _exports.Radio = _exports.OptionSelect = _exports.Label = _exports.Input = _exports.Form = _exports.Error = _exports.CheckboxGroup = _exports.Checkbox = void 0;
  const {
    Bundle: __Bundle
  } = dependency_0;
  ...
  ********************************/
  ...
  let CheckboxGroup = _exports.CheckboxGroup = void 0,
    Checkbox = _exports.Checkbox = void 0,
    Form = _exports.Form = void 0,
    Error = _exports.Error = void 0,
    Label = _exports.Label = void 0,
    Input = _exports.Input = void 0,
    Radio = _exports.Radio = void 0,
    Select = _exports.Select = void 0,
    OptionSelect = _exports.OptionSelect = void 0,
    Switch = _exports.Switch = void 0,
    Textarea = _exports.Textarea = void 0;
  ...
  __pkg.exports.process = function ({
    ...
    (require || prop === 'CheckboxGroup') && (_exports.CheckboxGroup = CheckboxGroup = require ? require('./checkbox/group').CheckboxGroup : value);
    (require || prop === 'Checkbox') && (_exports.Checkbox = Checkbox = require ? require('./checkbox/index').Checkbox : value);
    (require || prop === 'Form') && (_exports.Form = Form = require ? require('./form').Form : value);
    (require || prop === 'Error') && (_exports.Error = Error = require ? require('./input/components/error').Error : value);
    (require || prop === 'Label') && (_exports.Label = Label = require ? require('./input/components/label').Label : value);
    (require || prop === 'Input') && (_exports.Input = Input = require ? require('./input/index').Input : value);
    (require || prop === 'Radio') && (_exports.Radio = Radio = require ? require('./radio').Radio : value);
    (require || prop === 'Select') && (_exports.Select = Select = require ? require('./select/index').Select : value);
    (require || prop === 'OptionSelect') && (_exports.OptionSelect = OptionSelect = require ? require('./select/option').OptionSelect : value);
    (require || prop === 'Switch') && (_exports.Switch = Switch = require ? require('./switch').Switch : value);
    (require || prop === 'Textarea') && (_exports.Textarea = Textarea = require ? require('./textarea/index').Textarea : value);
  };
