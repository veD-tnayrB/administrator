...
import * as dependency_3 from 'react-select';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/form/react-select"},"type":"code"}, import.meta.url).package();;
...
ims.set('./index', {hash: 685704062, creator: function (require, exports) {
"use strict";
...
/*bundle*/function ReactSelect(props) {
  const properties = {
    ...props
  };
...
ims.set('./observer', {hash: 3933443758, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./index","from":"ReactSelect","name":"ReactSelect"}];

export let ReactSelect;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'ReactSelect') && (ReactSelect = require ? require('./index').ReactSelect : value);
...
//# sourceMappingURL=form/react-select.browser.mjs.map