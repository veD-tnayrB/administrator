...
import * as dependency_3 from 'swiper';
import * as dependency_4 from 'swiper/modules';
import * as dependency_5 from '@beyond-js/reactive/model';
import * as dependency_6 from '@beyond-js/kernel/styles';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/swiper"},"type":"code"}, import.meta.url).package();;
...
ims.set('./components/footer', {hash: 4152585320, creator: function (require, exports) {
"use strict";
...
ims.set('./components/navigation', {hash: 1445369557, creator: function (require, exports) {
"use strict";
...
ims.set('./components/pagination', {hash: 2024338772, creator: function (require, exports) {
"use strict";
...
ims.set('./context', {hash: 522084440, creator: function (require, exports) {
"use strict";
...
ims.set('./index', {hash: 4094575603, creator: function (require, exports) {
"use strict";
...
ims.set('./interfaces/swiper-props', {hash: 1706774564, creator: function (require, exports) {
"use strict";
...
ims.set('./slide/index', {hash: 721733334, creator: function (require, exports) {
"use strict";
...
ims.set('./slide/slide', {hash: 2855517027, creator: function (require, exports) {
"use strict";
...
ims.set('./state/controller', {hash: 1264338741, creator: function (require, exports) {
"use strict";
...
ims.set('./state/interface', {hash: 3704574833, creator: function (require, exports) {
"use strict";
...
ims.set('./use-swiper', {hash: 3766010187, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./index","from":"SwiperSlider","name":"SwiperSlider"}];

export let SwiperSlider;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'SwiperSlider') && (SwiperSlider = require ? require('./index').SwiperSlider : value);
...
//# sourceMappingURL=swiper.browser.mjs.map