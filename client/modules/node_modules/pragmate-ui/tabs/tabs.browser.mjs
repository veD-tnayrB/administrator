...
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/tabs"},"type":"code"}, import.meta.url).package();;
...
ims.set('./context', {hash: 1113529643, creator: function (require, exports) {
"use strict";
...
ims.set('./index', {hash: 1605311872, creator: function (require, exports) {
"use strict";
...
ims.set('./interfaces', {hash: 1404915735, creator: function (require, exports) {
"use strict";
...
ims.set('./panes', {hash: 2151215637, creator: function (require, exports) {
"use strict";
...
ims.set('./tab', {hash: 4224080064, creator: function (require, exports) {
"use strict";
...
ims.set('./tabs', {hash: 322980779, creator: function (require, exports) {
"use strict";
...
ims.set('./use-scroll', {hash: 1668718188, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./index","from":"TabsContainer","name":"TabsContainer"},{"im":"./panes","from":"Panes","name":"Panes"},{"im":"./tab","from":"Tab","name":"Tab"},{"im":"./tabs","from":"Tabs","name":"Tabs"}];

export let TabsContainer, Panes, Tab, Tabs;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'TabsContainer') && (TabsContainer = require ? require('./index').TabsContainer : value);
    (require || prop === 'Panes') && (Panes = require ? require('./panes').Panes : value);
    (require || prop === 'Tab') && (Tab = require ? require('./tab').Tab : value);
