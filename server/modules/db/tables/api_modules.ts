...
export class ApiModules
	extends Model<ApiModulesAttributes, ApiModulesCreationAttributes>
	implements ApiModulesAttributes
{
	declare id: string;
	declare name: string;
	...
	setProfileApiModulePermissions!: Sequelize.HasManySetAssociationsMixin<
		ProfileApiModulePermissions,
		ProfileApiModulePermissionsId
	>;
	addProfileApiModulePermission!: Sequelize.HasManyAddAssociationMixin<
		ProfileApiModulePermissions,
		ProfileApiModulePermissionsId
	>;
	addProfileApiModulePermissions!: Sequelize.HasManyAddAssociationsMixin<
		ProfileApiModulePermissions,
		ProfileApiModulePermissionsId
	>;
	createProfileApiModulePermission!: Sequelize.HasManyCreateAssociationMixin<ProfileApiModulePermissions>;
	removeProfileApiModulePermission!: Sequelize.HasManyRemoveAssociationMixin<
		ProfileApiModulePermissions,
		ProfileApiModulePermissionsId
	>;
	removeProfileApiModulePermissions!: Sequelize.HasManyRemoveAssociationsMixin<
		ProfileApiModulePermissions,
		ProfileApiModulePermissionsId
	>;
	hasProfileApiModulePermission!: Sequelize.HasManyHasAssociationMixin<
		ProfileApiModulePermissions,
		ProfileApiModulePermissionsId
	>;
	hasProfileApiModulePermissions!: Sequelize.HasManyHasAssociationsMixin<
		ProfileApiModulePermissions,
		ProfileApiModulePermissionsId
	>;
