...
export type ProfileApiModulePermissionsCreationAttributes = Optional<
	ProfileApiModulePermissionsAttributes,
	ProfileApiModulePermissionsOptionalAttributes
>;

export class ProfileApiModulePermissions
	extends Model<ProfileApiModulePermissionsAttributes, ProfileApiModulePermissionsCreationAttributes>
	implements ProfileApiModulePermissionsAttributes
{
	declare id: string;
