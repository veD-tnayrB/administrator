...
export type SentNotificationsCreationAttributes = Optional<
	SentNotificationsAttributes,
	SentNotificationsOptionalAttributes
>;

export class SentNotifications
	extends Model<SentNotificationsAttributes, SentNotificationsCreationAttributes>
	implements SentNotificationsAttributes
{
	declare id: string;
