...
export class AuthRoutes {
	...
	async forgetPassword(req: Request, res: Response) {
		try {
			...
			console.log('params: ', { params, validation: !params.email || typeof params !== 'string' });
	...
	setup(app: Application) {
		...
		app.get('/admin/auth/get-user', checkToken, this.getUser);
		app.get('/admin/auth/logout', checkToken, this.logout);
		app.get('/admin/auth/forget-password/:email', this.forgetPassword);
		app.put('/admin/auth/recover-password/:token', this.recoverPassword);
		app.put('/admin/auth/update/user/:userId', checkToken, this.update);
	}
}
