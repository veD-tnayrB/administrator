...
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/badge"},"type":"code"}, import.meta.url).package();;
...
ims.set('./index', {hash: 2882574013, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./index","from":"Badge","name":"Badge"}];

export let Badge;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'Badge') && (Badge = require ? require('./index').Badge : value);
...
//# sourceMappingURL=badge.browser.mjs.map