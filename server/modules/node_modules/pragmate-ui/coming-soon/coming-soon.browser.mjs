...
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/coming-soon"},"type":"widget"}, import.meta.url).package();;
...
brequire('@beyond-js/widgets/render').widgets.register([{"name":"coming-soon","vspecifier":"pragmate-ui@0.0.6/coming-soon","is":"page","route":"/components/coming-soon"}]);
...
ims.set('./controller', {hash: 994035166, creator: function (require, exports) {
"use strict";
...
ims.set('./views/index', {hash: 2558588589, creator: function (require, exports) {
"use strict";
