...
import * as dependency_4 from 'pragmate-ui/spinner';
import * as dependency_5 from 'pragmate-ui/ripple';
import * as dependency_6 from 'tippy.js';
import * as dependency_7 from '@beyond-js/kernel/routing';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/components"},"type":"code"}, import.meta.url).package();;
...
ims.set('./button-group/button-group', {hash: 3592527677, creator: function (require, exports) {
"use strict";
...
ims.set('./button-group/type', {hash: 872288252, creator: function (require, exports) {
"use strict";
...
ims.set('./button/button', {hash: 2984034171, creator: function (require, exports) {
"use strict";
...
/*bundle*/const Button = exports.Button = forwardRef((props, ref) => {
  const {
    className,
    onClick,
    data,
...
ims.set('./button/interface', {hash: 2774588843, creator: function (require, exports) {
"use strict";
...
ims.set('./link', {hash: 1920375694, creator: function (require, exports) {
"use strict";
...
ims.set('./spinner', {hash: 4243581074, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./button-group/button-group","from":"ButtonGroup","name":"ButtonGroup"},{"im":"./button/button","from":"Button","name":"Button"},{"im":"./link","from":"Link","name":"Link"},{"im":"./spinner","from":"Spinner","name":"Spinner"}];

export let ButtonGroup, Button, Link, Spinner;
