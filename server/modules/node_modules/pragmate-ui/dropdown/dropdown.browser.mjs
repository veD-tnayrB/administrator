...
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/dropdown"},"type":"code"}, import.meta.url).package();;
...
ims.set('./context', {hash: 4270738753, creator: function (require, exports) {
"use strict";
...
/*bundle*/function DropdownProvider(props) {
  const {
    children,
    isToggle,
    onToggle,
...
ims.set('./link', {hash: 3487775132, creator: function (require, exports) {
"use strict";
...
/*bundle*/function DropdownLink(props) {
  const {
    setShowMenu
...
ims.set('./menu', {hash: 281379387, creator: function (require, exports) {
"use strict";
...
ims.set('./toggle', {hash: 2970189459, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./context","from":"DropdownProvider","name":"DropdownProvider"},{"im":"./link","from":"DropdownLink","name":"DropdownLink"},{"im":"./menu","from":"DropDownMenu","name":"DropDownMenu"},{"im":"./toggle","from":"DropdownToggle","name":"DropdownToggle"}];

export let DropdownProvider, DropdownLink, DropDownMenu, DropdownToggle;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'DropdownProvider') && (DropdownProvider = require ? require('./context').DropdownProvider : value);
    (require || prop === 'DropdownLink') && (DropdownLink = require ? require('./link').DropdownLink : value);
    (require || prop === 'DropDownMenu') && (DropDownMenu = require ? require('./menu').DropDownMenu : value);
    (require || prop === 'DropdownToggle') && (DropdownToggle = require ? require('./toggle').DropdownToggle : value);
