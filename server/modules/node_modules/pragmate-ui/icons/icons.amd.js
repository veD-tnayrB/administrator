define(["exports", "module", "@beyond-js/kernel/bundle", "react", "tippy.js", "@beyond-js/kernel/routing", "pragmate-ui/ripple", "@beyond-js/kernel/styles"], function (_exports, _amd_module, dependency_0, dependency_1, dependency_2, dependency_3, dependency_4, dependency_5) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.hmr = _exports.__beyond_pkg = _exports.PRAGMATE_ICONS = _exports.IconButton = _exports.Icon = void 0;
  const {
    Bundle: __Bundle
  } = dependency_0;
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "pragmate-ui@0.0.6/icons"
    },
    "type": "code",
    "name": "icon"
...
`,
  ...
  **************************************/
  ...
  let Icon = _exports.Icon = void 0,
    PRAGMATE_ICONS = _exports.PRAGMATE_ICONS = void 0,
    IconButton = _exports.IconButton = void 0;
  ...
  __pkg.exports.process = function ({
    ...
    (require || prop === 'Icon') && (_exports.Icon = Icon = require ? require('./icon').Icon : value);
    (require || prop === 'PRAGMATE_ICONS') && (_exports.PRAGMATE_ICONS = PRAGMATE_ICONS = require ? require('./icons/index').PRAGMATE_ICONS : value);
    (require || prop === 'IconButton') && (_exports.IconButton = IconButton = require ? require('./pragmate-icon-button').IconButton : value);
  };
