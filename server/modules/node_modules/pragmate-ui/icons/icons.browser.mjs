...
import * as dependency_4 from 'pragmate-ui/ripple';
import * as dependency_5 from '@beyond-js/kernel/styles';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"pragmate-ui@0.0.6/icons"},"type":"code","name":"icon"}, import.meta.url).package();;
...
brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@0.0.6/icons')
...
ims.set('./icon', {hash: 1965980191, creator: function (require, exports) {
"use strict";
...
ims.set('./icons/index', {hash: 3593230374, creator: function (require, exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PRAGMATE_ICONS = void 0;
var _list = require("./list");
var _media = require("./media");
/*bundle*/const PRAGMATE_ICONS = exports.PRAGMATE_ICONS = {
  ..._list.GENERAL_ICONS,
  ..._media.MEDIA_ICONS
};
}});
...
ims.set('./icons/list', {hash: 41670343, creator: function (require, exports) {
"use strict";
...
const GENERAL_ICONS = exports.GENERAL_ICONS = {
  ...
  'copy-link': {
    viewBox: '0 0 24 24',
    icon: `<g>
		<path id="Trazado_189" data-name="Trazado 189" d="M0,0H24V24H0Z" fill="none"/>
		<path id="Trazado_190" data-name="Trazado 190" d="M17,7H13V9h4a3,3,0,0,1,0,6H13v2h4A5,5,0,0,0,17,7Zm-6,8H7A3,3,0,0,1,7,9h4V7H7A5,5,0,0,0,7,17h4ZM8,11h8v2H8Z" fill="#adc4cc"/>
	  </g>`
  },
...
ims.set('./icons/media', {hash: 1200940964, creator: function (require, exports) {
"use strict";
...
ims.set('./pragmate-icon-button', {hash: 3055897770, creator: function (require, exports) {
"use strict";
...
/*bundle*/const IconButton = exports.IconButton = (0, _react.forwardRef)((props, ref) => {
  const {
    icon,
    onClick,
    viewBox,
...
__pkg.exports.descriptor = [{"im":"./icon","from":"Icon","name":"Icon"},{"im":"./icons/index","from":"PRAGMATE_ICONS","name":"PRAGMATE_ICONS"},{"im":"./pragmate-icon-button","from":"IconButton","name":"IconButton"}];

export let Icon, PRAGMATE_ICONS, IconButton;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'Icon') && (Icon = require ? require('./icon').Icon : value);
    (require || prop === 'PRAGMATE_ICONS') && (PRAGMATE_ICONS = require ? require('./icons/index').PRAGMATE_ICONS : value);
    (require || prop === 'IconButton') && (IconButton = require ? require('./pragmate-icon-button').IconButton : value);
